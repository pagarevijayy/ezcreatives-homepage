...
const DesignImage = () => {
  ...
  const twitterSVG = (
    ...
    >
      <path
        d="M15.762 2.29134C15.2053 2.53801 14.6073 2.70468 13.9787 2.78001C14.6273 2.39187 15.1126 1.78099 15.344 1.06134C14.7346 1.42334 14.0676 1.67814 13.372 1.81468C12.9043 1.31525 12.2847 0.984228 11.6095 0.872993C10.9344 0.761759 10.2414 0.876538 9.63816 1.19951C9.03492 1.52249 8.55518 2.03559 8.27343 2.65915C7.99169 3.28271 7.92369 3.98184 8.08 4.64801C6.84512 4.58601 5.63708 4.26504 4.53428 3.70595C3.43148 3.14685 2.45856 2.36212 1.67866 1.40268C1.412 1.86268 1.25866 2.39601 1.25866 2.96401C1.25837 3.47534 1.38429 3.97884 1.62525 4.42983C1.86621 4.88083 2.21477 5.26537 2.64 5.54934C2.14685 5.53365 1.66458 5.4004 1.23333 5.16068V5.20068C1.23328 5.91784 1.48135 6.61293 1.93545 7.16801C2.38955 7.72309 3.02171 8.10396 3.72466 8.24601C3.26719 8.36982 2.78756 8.38806 2.322 8.29934C2.52033 8.91642 2.90666 9.45603 3.42691 9.84263C3.94716 10.2292 4.57528 10.4435 5.22333 10.4553C4.12322 11.319 2.76459 11.7874 1.366 11.7853C1.11825 11.7854 0.870715 11.7709 0.624664 11.742C2.04432 12.6548 3.69689 13.1392 5.38466 13.1373C11.098 13.1373 14.2213 8.40534 14.2213 4.30134C14.2213 4.16801 14.218 4.03334 14.212 3.90001C14.8195 3.46066 15.3439 2.91661 15.7607 2.29334L15.762 2.29134V2.29134Z"
        fill="#E5E7EB"
      />
    </svg>
  );
    ...
    <div className="p-12">
      ...
      <div className="flex flex-wrap gap-6">
        <div className="design-wrapper">
          2.
          <div
            className="design-template flex flex-col justify-center w-96 h-auto px-4 py-4 text-left text-lg bg-black text-gray-200"
            ref={componentRef}
          >
            <section className="space-y-2">
              <p>
                "It is not death that a man should fear, but he should fear
                never beginning to live." <span>Bob Marley </span>{" "}
        ...
        <div className="design-wrapper">
          ...
          >
            <section className="space-y-2">
              ...
              <p className="flex items-center justify-start transform text-xs pt-1">
                <span>{instaSVG}</span>{" "}
                <span className="pl-1">{twitterSVG}</span>{" "}
                <span className="pl-1"> wethesapiens_ </span>
              </p>
            </section>
          </div>
        </div>
