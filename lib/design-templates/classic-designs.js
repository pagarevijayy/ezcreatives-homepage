...
export const Wisdom4 = ({
  ...
  const clipPath1 =
    "polygon(1% 100%, 0% 1%, 100% 0%, 100% 99%, 96% 95%, 92% 100%, 87% 98%, 83% 100%, 72% 99%, 63% 94%, 59% 97%, 59% 98%, 45% 98%, 37% 100%, 36% 95%, 31% 97%, 20% 94%, 16% 100%, 11% 97%)";
    ...
    <div className="design-wrapper">
      <div className="w-96 h-96 bg-gray-100">
        ...
        <div className=" h-48 flex flex-col items-center justify-end text-center">
          ...
          <p className=" my-6 text-xs font-medium tracking-wider uppercase">
            {author}
          </p>
        </div>
      </div>
...
export const SquareQuote = ({
  ...
  return (
    <div className="design-wrapper">
      <div className="p-8 w-96 h-96 flex flex-col justify-between bg-gray-100">
        <div>
  ...
  return (
    <div className="design-wrapper">
      ...
      >
        ...
        <div className="mt-6 absolute bottom-0 h-1/2 border-t-4 border-white">
          <img
